...
public:
     ...
     */
    UnlabeledValueArg(const std::wstring &name, const std::wstring &desc,
                      bool req, T value, const std::wstring &typeDesc,
    ...
    virtual std::wstring longID(const std::wstring &) const {
        return Arg::getName() + L" <" + _typeDesc + L">";
    }
...
UnlabeledValueArg<T>::UnlabeledValueArg(const std::wstring &name,
                                        ...
                                        T val, const std::wstring &typeDesc,
