...
public:
     ...
     */
    SwitchArg(const std::wstring &flag, const std::wstring &name,
              const std::wstring &desc, bool def = false, Visitor *v = NULL);
     ...
     */
    SwitchArg(const std::wstring &flag, const std::wstring &name,
              const std::wstring &desc, ArgContainer &parser, bool def = false,
              Visitor *v = NULL);
...
// BEGIN SwitchArg.cpp
//////////////////////////////////////////////////////////////////////
inline SwitchArg::SwitchArg(const std::wstring &flag, const std::wstring &name,
                            const std::wstring &desc, bool default_val,
                            Visitor *v)
...
inline SwitchArg::SwitchArg(const std::wstring &flag, const std::wstring &name,
                            const std::wstring &desc, ArgContainer &parser,
