...
public:
     ...
     */
    MultiSwitchArg(const std::wstring &flag, const std::wstring &name,
                   const std::wstring &desc, int init = 0, Visitor *v = NULL);
     ...
     */
    MultiSwitchArg(const std::wstring &flag, const std::wstring &name,
                   const std::wstring &desc, ArgContainer &parser, int init = 0,
                   Visitor *v = NULL);
...
inline MultiSwitchArg::MultiSwitchArg(const std::wstring &flag,
                                      ...
                                      const std::wstring &desc, int init,
                                      Visitor *v)
...
inline std::wstring MultiSwitchArg::shortID(const std::wstring &val) const {
    return Arg::shortID(val) + L" ...";
}

inline std::wstring MultiSwitchArg::longID(const std::wstring &val) const {
