...
#include <wtclap/MultiArg.h>
#include <wtclap/OptionalUnlabeledTracker.h>
...
public:
     ...
     */
    UnlabeledMultiArg(const std::wstring &name, const std::wstring &desc,
                      bool req, const std::wstring &typeDesc,
     ...
     */
    virtual std::wstring shortID(const std::wstring &) const {
        return Arg::getName() + L" ...";
    }
     ...
     */
    virtual std::wstring longID(const std::wstring &) const {
        return Arg::getName() + L" (accepted multiple times) <" + _typeDesc +
               L">";
    }
...
UnlabeledMultiArg<T>::UnlabeledMultiArg(const std::wstring &name,
                                        ...
                                        bool ignoreable, Visitor *v)
    : MultiArg<T>(L"", name, desc, req, constraint, v) {
    _ignoreable = ignoreable;
    OptionalUnlabeledTracker::check(true, toString());
}
